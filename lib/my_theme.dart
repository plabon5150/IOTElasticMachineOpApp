...
class MyTheme {
  ...
  static Color accent_color =
      Color.fromRGBO(25, 118, 210, 1); //Color.fromRGBO(24, 167, 85, 1) ;
  static Color accent_color_shadow =
      Color.fromRGBO(70, 255, 0, 1); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(107, 176, 245, 1);
  static Color splash_screen_color = Color.fromRGBO(0, 2, 211,
      215); //Color.fromRGBO(24, 167, 85, 1); // if not sure , use the same color as accent color

  //Color.Hex(#fc00ff, #00dbde)
